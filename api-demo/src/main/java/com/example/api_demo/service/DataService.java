...
/**
 * Service layer responsible for retrieving and processing {@link DataRecord} objects.
...
public class DataService {
    ...
    public List<DataRecord> getData(int limit){

        return repo.findDataWithLimit(limit);
    }
